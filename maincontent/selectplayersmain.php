...
echo '<main>
            ...
            <article class="selected-team">
                <button class="select-player-button" id="appearanceOnChallenge2" hidden="hidden" disabled>YOU</button>
                ...
                <!--It should only show the prompt if a player has been selected for every position-->
                <!--onclick="alert(`Are you sure you want to save this selection?`)"-->
                <button class="players-list" id="disappearOnChallenge" onclick="onChallenge()">CHALLENGE</button>
            </article>
